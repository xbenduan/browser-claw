...
const Modal: React.FC<ModalProps> = ({
  ...
  return createPortal(
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
      {/* Backdrop */}
      <div
        className={`fixed inset-0 bg-slate-900/30 backdrop-blur-[3px] transition-opacity duration-200 ease-out ${
      ...
      <div
        ref={modalRef}
        className={`relative w-full ${width} ${height} bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200/60 overflow-hidden flex flex-col transform transition-all duration-200 ease-out ${
          isVisible
      ...
      >
        {/* Header */}
        <div className="px-6 py-4 border-b border-slate-200/60 bg-slate-50/80 flex justify-between items-center shrink-0">
